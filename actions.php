    ...
    if ( $exec == "scroll" ) {
        ...
        foreach ( $registros as $registro ) {
            $html .= '<div class="cupom" style="height:auto;">
                        ...
                        <a href="javascript:void(0);" onclick="checkSession('.$registro['cupomID'].')" class="btn btn-primary" style="width:100%; padding-left: 12px; text-align: center;">Faça seu pedido agora!</a>
                      </div>';
        }
